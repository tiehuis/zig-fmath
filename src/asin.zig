...
test "asin" {
    ...
    fmath.assert(asin(f64(0.0)) == asin64(0.0));
}
...
test "asin64" {
    ...
    fmath.assert(fmath.approxEq(f64, asin64(0.0), 0.0, epsilon));
    fmath.assert(fmath.approxEq(f64, asin64(0.2), 0.201358, epsilon));
    fmath.assert(fmath.approxEq(f64, asin64(-0.2), -0.201358, epsilon));
    fmath.assert(fmath.approxEq(f64, asin64(0.3434), 0.350535, epsilon));
    fmath.assert(fmath.approxEq(f64, asin64(0.5), 0.523599, epsilon));
    fmath.assert(fmath.approxEq(f64, asin64(0.8923), 1.102415, epsilon));
}
