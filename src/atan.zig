...
test "atan" {
    ...
    fmath.assert(atan(f64(0.2)) == atan64(0.2));
}
...
test "atan64" {
    ...
    fmath.assert(fmath.approxEq(f64, atan64(0.2), 0.197396, epsilon));
    fmath.assert(fmath.approxEq(f64, atan64(-0.2), -0.197396, epsilon));
    fmath.assert(fmath.approxEq(f64, atan64(0.3434), 0.330783, epsilon));
    fmath.assert(fmath.approxEq(f64, atan64(0.8923), 0.728545, epsilon));
    fmath.assert(fmath.approxEq(f64, atan64(1.5), 0.982794, epsilon));
}
