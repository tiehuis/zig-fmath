...
test "exp2" {
    ...
    fmath.assert(exp2(f64(0.8923)) == exp2d(0.8923));
}
...
test "exp2d" {
    ...
    fmath.assert(exp2d(0.0) == 1.0);
    fmath.assert(fmath.approxEq(f64, exp2d(0.2), 1.148698, epsilon));
    fmath.assert(fmath.approxEq(f64, exp2d(0.8923), 1.856133, epsilon));
    fmath.assert(fmath.approxEq(f64, exp2d(1.5), 2.828427, epsilon));
    // fmath.assert(fmath.approxEq(f64, exp2d(37.45), 18379273786760560.000000, epsilon));
}
